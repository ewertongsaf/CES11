...
#ifndef CES11_VECTOR_H
#define CES11_VECTOR_H
 ...
 * @param [const int elemSize]: tamanho, em bytes, de cada elemento a ser
 *        armazenado no vetor.
 * @param [const int n]: numero inicial de elementos do vetor.
 * @return [c11vector *]: ponteiro para o vetor recem-criado, ou NULL em
 ...
 * @return [void *]: ponteiro para o i-esimo elemento do vetor. O ponteiro
 *         e invalidado por qualquer operacao que realoque o buffer interno.
 */
 ...
 *        deslocando os elementos seguintes, e retorna um ponteiro para
 *        esse espaco (para que o chamador escreva o valor desejado).
...
/*
 * @brief Remove o primeiro elemento do vetor, deslocando os elementos
 *        restantes uma posicao para frente.
